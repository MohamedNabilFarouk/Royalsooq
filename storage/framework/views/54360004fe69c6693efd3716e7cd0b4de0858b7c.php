...
">
                               <h4 class="card-title">
									...
									<span>you last logged in at <?php echo e(Carbon\Carbon::parse($user->login_at)->format('d M Y')); ?> </span>
                           </div>
...
<?php echo csrf_field(); ?>
  ...
  <input type="hidden" name="image" v-model="image_path" />
                ...
                <a href="<?php echo e(route('account.image.delete')); ?>" class="btn btn-danger">Delete Image</a>
...
">
									<h4 class="card-title">
										<a href="#photoPanel" data-toggle="collapse" data-parent="#accordion" aria-expanded="true" class="">setting</a>
									</h4>
								</div>
...
>
                        ...
                        <div class="col-md-6" >
                            ...
                            <?php endif; ?>
                                ...
                                <div class="form-group" style="display: inline-flex;    width: 80%;">
                                    <label style="width: 100%;" for="">E-mail</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_volcano_projects\Royal-details\royal_git\resources\views/account/dashboard.blade.php ENDPATH**/ ?>