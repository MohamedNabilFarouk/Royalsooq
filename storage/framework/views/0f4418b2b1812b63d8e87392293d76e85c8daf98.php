                ...
                <div class="col-md-12">
                    ...
                    <div class="row row-wrap">
                     ...
                     <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a class="col-md-3" href="<?php echo e(route('shops2', $u->id)); ?>">

                            <div class="product-thumb">

                                <header class="product-header">

                                    <img src="<?php echo e(asset('/storage/'. $u->image)); ?>" alt="<?php echo e($u->name); ?>" title="The Hidden Power of the Heart" style="height: 189px;" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/royal2.royalsooq.com/resources/views/blades/allSellerAcc.blade.php ENDPATH**/ ?>