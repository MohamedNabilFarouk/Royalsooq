...
<ul class="breadcrumb">
                    ...
                    <li><a href="index-2.html"><i aria-hidden="true" class="fa fa-home"></i><?php echo e(__('index.home')); ?></a>
...
<avored-layout inline-template>
    ...
    border: #e2e2e2 1px solid;">
        ...
        <?php endif; ?>
                        ...
                        <?php echo e(count(Auth::user()->chat)); ?>


													<em><?php echo e(__('index.mails')); ?></em>
										...
										<div class="mcol-right">
											...
											<p>
												...
												<a href="">
													...
													<em><?php echo e(__('index.visit')); ?></em>
									...
									<div class="hdata">
										...
										<div class="mcol-right">
											...
											<p>
												...
												<?php echo e(count($userAds)); ?>


													<em> <?php echo e(__('index.ads')); ?></em>
										...
										<div class="mcol-right">
											...
											<p>
												...
												<a href="<?php echo e(route('favorites')); ?>">
													...
													<?php echo e(count($userFavorites)); ?>


													<em> <?php echo e(__('index.fav')); ?> </em>
...
">
                               ...
                               <h4 class="card-title">
										...
										<a href="#photoPanel" data-toggle="collapse" data-parent="#accordion" aria-expanded="true" class=""><?php echo e(__('index.hello')); ?>  <?php echo e(Auth::user()->name); ?></a>
...
"><?php echo e(__('index.file_upload')); ?></h2>
...
<?php echo csrf_field(); ?>
  ...
  <img id="userImg" class="userImg big" src="<?php echo e(asset('img/user_avatar.jpg')); ?>" alt="user">&nbsp;



        <?php else: ?>

  <img id="userImg" class="userImg big" src="<?php echo e(asset('/storage/' . Auth::user()->image)); ?>" alt="user"
...
"></i></label>
                          ...
                          <?php if(($user->password) == null ): ?> <!-- create password -->
                    ...
                    <!-- ********************* -->
                        ...
                        <a href="" style="color:gray; "><i class="fa fa-eye-slash" aria-hidden="true"></i> <?php echo e(__('index.show_pass')); ?></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/resources/views/account/dashboard.blade.php ENDPATH**/ ?>