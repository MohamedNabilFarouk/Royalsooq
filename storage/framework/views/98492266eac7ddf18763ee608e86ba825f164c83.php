...
<div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="#" class="">Royalsooq Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="#" class="breadcrumb--active">Dashboard</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                                ...
                                <div class="cursor-pointer relative flex items-center ">
                                    ...
                                    <div class="ml-2 overflow-hidden">
                                        <div class="flex items-center">
                                            <a href="javascript:;" class="font-medium truncate mr-5"><?php echo e($note->data['data']); ?></a> 
                                            <div class="text-xs text-gray-500 ml-auto whitespace-no-wrap"><?php echo e($note->created_at); ?></div>
                                        </div>
                    ...
                    <div class="intro-x dropdown">
                        <div class="dropdown-toggle ">
                            <h6><?php echo e(Auth::guard('admin')->user()->full_name); ?></h6>
                        ...
                        <div class="dropdown-box w-56">
                            <div class="dropdown-box__content box bg-theme-38 dark:bg-dark-6 text-white">
                                ...
                                <form method="post" action="<?php echo e(route('admin.logout')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <a onclick="this.parentNode.submit();" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="toggle-right" class="w-4 h-4 mr-2"></i> Logout </a>
                               </form>
                                </div>
                            </div>
                        </div>
                ...
                <!-- END: Top Bar --><?php /**PATH E:\Billy\laravel_volcano_projects\Royal-details\new_royal\vendor\avored\framework\src/../resources/views/mylayouts/inc-top.blade.php ENDPATH**/ ?>