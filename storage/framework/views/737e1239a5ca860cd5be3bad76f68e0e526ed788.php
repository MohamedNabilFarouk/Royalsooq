...
<meta property="og:title" content="<?php echo e($products[0]->name); ?>" />
<meta property="og:type" content="Ad" />
<meta property="og:image" content="<?php echo e($products[0]->main_image_url); ?>" />
<meta property="og:description" content="<?php echo e($products[0]->description); ?> | RoyalSooq " /> 
...
">
							...
							<strong>
								...
								<?php echo e($products[0]->name); ?>


                                </a>

                            </strong>
<?php if($products[0]->negotiable == 1): ?>
    <h5>(<?php echo e(__('index.negotiable')); ?>)</h5>
    <?php endif; ?>
							...
							<span class="date"><i class="fa fa-map-marker"> </i>  <?php echo e($products[0]->city->city ?? ''); ?> </span> -&nbsp;
...
"><?php echo e(date_format($products[0]->created_at,'d M Y')); ?></span></li></span> -&nbsp;

							<span class="category">

								<i class="fa fa-eye"></i>

<?php echo e($products[0]->visits()->count()); ?> <?php echo e(__('index.views')); ?>
								...
								<span class="category"><?php echo e($products[0]->categories->name); ?></span> 
                            ...
                            <?php echo e($products[0]->country->currency); ?>  <?php echo e($products[0]->price); ?>
...
<?php if(count($products[0]->images) == 1): ?>
                        ...
                        <img src="<?php echo e($products[0]->main_image_url); ?>" alt="Image Alternative text" style="width:100%; max-height: 400px;" title="<?php echo e($products[0]->name); ?>" />
...
<a href="<?php echo e(route('shops2', $products[0]->user->id)); ?>"> 

<div class="col-md-4">

                                <?php if(empty($products[0]->user->image)): ?>

                        

                <img id="userImg" class="userImg" src="<?php echo e(asset('img/user_avatar.jpg')); ?>" alt="$products[0]->user->name" style=" 
...
">&nbsp;
        ...
        <img src="<?php echo e(asset('/storage/'. $products[0]->user->image)); ?>" class="seller-image" alt="<?php echo e($products[0]->user->name); ?>" style="
...
<a href="<?php echo e(route('shops2', $products[0]->user->slug)); ?>"><h6 class="title"><?php echo e(__('index.posted_by')); ?> : <span style="color:gray"><?php echo e($products[0]->user->name); ?></span>   </h6></a>
...
<style>
  ...
  color: orange;
                                ...
                                <p class="text-smaller text-muted" style="max-height: 179px;overflow: hidden;"><?php echo $products[0]->description; ?></p>
                                ...
                                <ul class="icon-list list-space product-info-list">
                                    ...
                                    <li><i class="fa fa-check"></i><?php echo e(__('index.approved')); ?></li>

                                    <li><i class="fa fa-map-marker"></i><?php echo e($products[0]->city->city ?? ''); ?> | <?php echo e($products[0]->city->country->name ?? ''); ?> </li>

                                    <!-- <li><i class="fa fa-time"></i><?php echo e(date_format($products[0]->created_at,'d M Y')); ?></li> -->
                                ...
                                <ul class="list-inline">
                                     ...
                                     <li style="margin-top: 20px;"><a href="tel:<?php echo $products[0]->user->phone ?? null; ?>" data-toggle="tab" ><button  data-toggle="tab" onclike="tel:<?php echo $products[0]->user->phone ?? null; ?>" class="btn kos btn-2 btn-sep fa fa-phone" id="button"><?php echo e(__('index.appear_phone')); ?> </button></a>
...
function updateStatus() {
    ...
    button.textContent = '<?php echo $products[0]->user->phone ?? null; ?>';
...
.btn-2:active {
	...
	top: 2px;
                                    ...
                                    <li style="margin-top: 20px;"><a href="<?php echo e(route('chat.message',$products[0]->id)); ?>" ></a><button onclick="#tab-2" data-toggle="tab"  class="btn kos btn-2 btn-sep fa fa-comment" style="

    background: #ffde00;

"><?php echo e(__('index.contact_with_seller')); ?></button></a>
...
">
                         ...
                         <h3 style="text-align:center;font-size: larger;background: white;padding: 14px;"><?php echo e(__('index.safety')); ?></h3>

                    <ul class="icon-list list-space product-info-list">

                                    <li><i class="fa fa-check"></i><?php echo e(__('index.meet')); ?></li>

                                    <li><i class="fa fa-check"></i><?php echo e(__('index.check')); ?></li>

                                    <li><i class="fa fa-check"></i><?php echo e(__('index.pay')); ?></li>
                ...
                <a href="<?php echo e(route('product.details', $product->slug)); ?>">
                    ...
                    <div class="product-thumb">
                        ...
                        <header class="product-header">
                            ...
                            <img src="<?php echo e($product->main_image_url); ?>" alt="Image Alternative text" title="Gamer Chick" style="" />
                        ...
                        <?php echo str_repeat('<span class="fa fa-star"></span>', 5 - number_format($product->averageRating)) ?> 
                            ...
                            <div class="product-meta">
                                ...
                                <ul class="product-price-list">
                                    ...
                                    <li><span class="product-price"><?php echo e($product->price); ?> <?php echo e($products[0]->country->currency); ?></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/resources/views/blades/productdetails.blade.php ENDPATH**/ ?>