...
<div class="row row-wrap" style="display: flex;justify-content: center;">
            ...
            <div class="col-md-8 col-12 text-center ">
                            ...
                            <div class="radio">
                  <label><input type="radio" value='latest' name="home_position" checked> Latest Ads</label>
                  <label><input type="radio" value='featured' name="home_position"> Featured Ads</label>
                  <label><input type="radio" value='weekly' name="home_position"> Weekly Sponsored</label>
                                                ...
                                                <div class="row row-wrap" style="display: flex;justify-content: center;">
                                                    ...
                                                    <input class="btn btn-info" type='submit' name='submit' value='Approve'>
...
<?php echo $__env->make('avored::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_volcano_projects\Royal-details\royal_git\vendor\avored\framework\src/../resources/views/catalog/product/show.blade.php ENDPATH**/ ?>