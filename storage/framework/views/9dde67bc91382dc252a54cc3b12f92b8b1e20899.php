    ...
    <form action="<?php echo e(route('order.place')); ?>" method='post'>
      ...
      <a-row :gutter="15">
        ...
        <a-col :span="12">
              ...
              <input type='hidden' value='<?php echo e(Cart::total() - Cart::discount()); ?>' name="total_price">
                <a-button
                    type="primary"
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_volcano_projects\Royal-details\royal_git\resources\views/checkout/show.blade.php ENDPATH**/ ?>