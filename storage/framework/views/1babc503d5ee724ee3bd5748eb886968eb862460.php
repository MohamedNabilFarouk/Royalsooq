    ...
    <div class="col-md-12">
            ...
            <div class="row row-wrap" style="display: flex;justify-content: center;">
                                ...
                                <div class="col-md-8 col-12 text-center ">
                                      ...
                                      <input type="text" name="code" class="form-control" value="<?php echo e($ads->code); ?>" placeholder="Title" readonly>
            ...
            <div class="row row-wrap" style="display: flex;justify-content: center;">
                                         ...
                                         <textarea name="link"  class="form-control"><?php echo e($ads->link); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('avored::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_volcano_projects\Royal-details\royal_git\vendor\avored\framework\src/../resources/views/catalog/ads/edit.blade.php ENDPATH**/ ?>