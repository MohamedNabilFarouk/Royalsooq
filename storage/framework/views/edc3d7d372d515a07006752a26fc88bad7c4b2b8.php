...
<section class="contact-1">
  <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-7">
              <div class="section-title mb-2">
                <!-- <h6>Get In Touch</h6> -->
                <h2><?php echo e(__('index.contact_us')); ?></h2> 
              </div>
              ...
              <form name="contactForm"  class="contact-form" method="post" action="<?php echo e(route('contactus.store')); ?>">
                  ...
                  <div class="form-group col-md-6">
                    <input id="form_name" type="text" name="name" class="form-control" placeholder="<?php echo e(__('index.name')); ?>" required="required" data-error="Name is required.">
                   
                  </div>
                  <div class="form-group col-md-6 .">
                    <input id="form_email" type="email" name="email" class="form-control" placeholder="<?php echo e(__('index.email')); ?>" required="required" data-error="Valid email is required.">
                   
                  </div>
                 
                  <div class="form-group col-md-12 .">
                    <textarea id="form_message" name="message" class="form-control" placeholder="<?php echo e(__('index.message')); ?>" rows="4" required="required" data-error="Please,leave us a message."></textarea>
                
                  </div>
                  <div class="col-md-12">
                  <button class="btn btn-theme btn-radius"><span><?php echo e(__('index.send')); ?></span>
                  </button>
                  </div>
                </form>
              </div>
    ...
    color: #2a8fbd;
    text-align: center;
"></i><span><?php echo e(__('index.address')); ?>:</span>
                  <p><?php echo $add; ?></p>
                </li>
    ...
    color: #2a8fbd;
    text-align: center;
"></i><span><?php echo e(__('index.email')); ?></span><a href="mailto:themeht23@gmail.com"> <?php echo str_replace(' ','<br>', $cs_email[0]->english) ?></a>
                <!-- </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/resources/views/blades/contactus.blade.php ENDPATH**/ ?>