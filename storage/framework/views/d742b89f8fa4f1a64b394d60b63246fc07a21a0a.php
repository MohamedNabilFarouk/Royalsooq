                        ...
                        <avored-layout inline-template>
                            ...
                            <div class='col-md-9' style="  background-color: #f5f5f5; padding: 2%;margin-top: 0px;border: #e2e2e2 1px solid;">
                                        <a-row type="flex" class="mb-1" justify="start">
                                            <a-col>
                                                <h1><?php echo e(__('index.orders')); ?></h1>
                                            </a-col>
                                        </a-row>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/resources/views/account/order/index.blade.php ENDPATH**/ ?>