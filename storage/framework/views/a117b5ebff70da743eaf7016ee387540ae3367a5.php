...
<form method="post" action="<?php echo e(route('admin.product.approve.all')); ?>">
        ...
        <tbody>
            ...
            <tr>
                <?php echo csrf_field(); ?>
            <td><input type="checkbox" id="approve" name="product_id[]" value="<?php echo e($p->id); ?>"></td>
            </form>
...
<?php echo $__env->make('avored::mylayouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/vendor/avored/framework/src/../resources/views/catalog/product/index.blade.php ENDPATH**/ ?>