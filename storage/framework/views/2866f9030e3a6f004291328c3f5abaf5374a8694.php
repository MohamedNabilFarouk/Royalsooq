...
<div id="app">
    ...
    <a-col :span="24">
        <system-role-save
            ...
            role="<?php echo e($role); ?>" inline-template>
        <div>
            <a-form 
                :form="roleForm"
                method="post"
                action="<?php echo e(route('admin.role.update', $role->id)); ?>"                    
                @submit="handleSubmit"
            >
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('avored::mylayouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/vendor/avored/framework/src/../resources/views/system/role/edit.blade.php ENDPATH**/ ?>