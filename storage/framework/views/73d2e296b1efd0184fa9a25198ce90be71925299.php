    ...
    <div class="login-form mt-3">
        <form role="form" action="<?php echo e(route('register')); ?>" method="post" id="login-form" autocomplete="off" onsubmit="return termsFunction()">
            ...
            <div class="form-group">
                ...
                <div class="form-line">
                    <input type="text" id='name' class="form-control" name="name" placeholder="<?php echo e(__('index.name')); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-line">
                    <input type="email" class="form-control" id='email' name="email" placeholder="<?php echo e(__('index.email')); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-line">
                    <input type="number" class="form-control" id='phone' name="phone" placeholder="<?php echo e(__('index.phone')); ?>">
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="form-line">
                    <input type="password" class="form-control" id="pass" name="password" placeholder="<?php echo e(__('index.password')); ?>">
                </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="form-line">
                    <input type="password" class="form-control" id="conf_pass" name="password_confirmation" placeholder="<?php echo e(__('index.pass_confirmition')); ?>">
                </div>
                <span class="material-icons-outlined icon-label-right">visibility_off</span>
            </div>
...
<!-- end captcha -->
            ...
            <div class="clear"></div>
            <button href="login.html" type="submit" class="theme-button large xl btn-primary"><?php echo e(__('index.sign_up')); ?></button>
        </form>
    </div>
    ...
    <span class="text-muted"><?php echo e(__('index.reg_slogan')); ?> <a href="<?php echo e(url('login')); ?>" class="col-text font-weight-bold"><?php echo e(__('index.log_in')); ?></a> </span>
</div>
