                            ...
                            <div class="tab-pane fade" id="tab-4">
                                <ul class="comments-list">
                                    <li>
                                        ...
                                        <article class="comment">
                                            <div class="comment-author">
                                                <img src="<?php echo e(asset('img/gamer_chick_50x50.jpg')); ?>" alt="Image Alternative text" title="Gamer Chick" />
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <article class="comment">
                                            <div class="comment-author">
                                                <img src="<?php echo e(asset('img/gamer_chick_50x50.jpg')); ?>" alt="Image Alternative text" title="Ana 29" />
                                            </div>
                                            <div class="comment-inner">
                                                <ul class="icon-group icon-list-rating comment-review-rate" title="4/5 rating">
                                                    <li><i class="fa fa-star"></i>
                                    ...
                                    <li>
                                        ...
                                        <article class="comment">
                                            <div class="comment-author">
                                                <img src="<?php echo e(asset('img/gamer_chick_50x50.jpg')); ?>" alt="Image Alternative text" title="Afro" />
                                            </div>
                                            <div class="comment-inner">
                                    ...
                                    <li>
                                        ...
                                        <article class="comment">
                                            <div class="comment-author">
                                                <img src="<?php echo e(asset('img/gamer_chick_50x50.jpg')); ?>" alt="Image Alternative text" title="Bubbles" />
                                            </div>
                                            <div class="comment-inner">
                                                <ul class="icon-group icon-list-rating comment-review-rate" title="4/5 rating">
                                                    <li><i class="fa fa-star"></i>
                                    ...
                                    <li>
                                        ...
                                        <article class="comment">
                                            <div class="comment-author">
                                                <img src="<?php echo e(asset('img/gamer_chick_50x50.jpg')); ?>" alt="Image Alternative text" title="Me with the Uke" />
                                            </div>
                                            <div class="comment-inner">
                                                <ul class="icon-group icon-list-rating comment-review-rate" title="4/5 rating">
                                                    <li><i class="fa fa-star"></i>
                                    ...
                                    <li>
                                        ...
                                        <article class="comment">
                                            <div class="comment-author">
                                                <img src="<?php echo e(asset('img/gamer_chick_50x50.jpg')); ?>" alt="Image Alternative text" title="AMaze" />
                                            </div>
                                            <div class="comment-inner">
                                                <ul class="icon-group icon-list-rating comment-review-rate" title="4/5 rating">
                                                    <li><i class="fa fa-star"></i>
                                    ...
                                    <li>
                                        ...
                                        <article class="comment">
                                            <div class="comment-author">
                                                <img src="<?php echo e(asset('img/gamer_chick_50x50.jpg')); ?>" alt="Image Alternative text" title="Chiara" />
                                            </div>
                                            <div class="comment-inner">
                                                <ul class="icon-group icon-list-rating comment-review-rate" title="5/5 rating">
                                                    <li><i class="fa fa-star"></i>
                                    ...
                                    <li>
                                        ...
                                        <article class="comment">
                                            <div class="comment-author">
                                                <img src="<?php echo e(asset('img/gamer_chick_50x50.jpg')); ?>" alt="Image Alternative text" title="Andrea" />
                                            </div>
                                            <div class="comment-inner">
                                                <ul class="icon-group icon-list-rating comment-review-rate" title="5/5 rating">
                                                    <li><i class="fa fa-star"></i>
                    ...
                    <div class="product-thumb">
                        ...
                        <div class="product-inner">
                            ...
                            <div class="product-meta">
                                ...
                                <?php endif; ?> -->
                                    <li><a href='<?php echo e($product->slug); ?>' class="btn btn-sm"><i class="fa fa-bars"></i> Details</a>
                                    <a href="<?php echo e($product->slug); ?>" class="btn btn-sm" style="
    background: #46c505;
    color: #fff;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_volcano_projects\Royal-details\royal_git\resources\views/blades/productdetails.blade.php ENDPATH**/ ?>