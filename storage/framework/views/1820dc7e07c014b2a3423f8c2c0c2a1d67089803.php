            ...
            <div class="row head" style="height: 430px; display: flex; justify-content: center;align-items: center;">
                ...
                <div class="col-12 col-md-8" >
                    <div class="owl-carousel owl-slider" id="owl-carousel-slider" data-inner-pagination="true" data-white-pagination="true">
                        ...
                        <div>
                            <div class="bg-holder">
                                <img src="<?php echo e(asset($s->image)); ?>" alt="<?php echo e($s->title); ?>" title="Branding  iPad Interactive Design" />
  ...
  color: #626262;border: solid 1px #fdeb18;"><i class="fa fa-comment" style=" color: #fdeb18;"></i> <?php echo e(__('index.chat')); ?></a>
   ...
   color: #626262; border: solid 1px #73b902;"><i class="fa fa-phone"style="    color: #73b902;"></i> <?php echo e(__('index.call')); ?></a>
            ...
            <div class="row row-wrap home-owlC2 animated" id='2ndHomeSection'>
                ...
                <div>
                    <div class="product-banner">
                        <img src="<?php echo e(asset('img/urbex_esch_lux_with_laney_and_laaaaag_800x600.jpg')); ?>" alt="Image Alternative text" title="Urbex Esch/Lux with Laney and Laaaaag" />
                        <div class="product-banner-inner">
                ...
                <div>
                    <div class="product-banner">
                        <img src="<?php echo e(asset('img/amaze_800x600.jpg')); ?>" alt="Image Alternative text" title="AMaze" />
                        <div class="product-banner-inner">
             ...
             <div class="row row-wrap home-owlC2 animated" id='7thHomeSection'>
               ...
               <?php $__currentLoopData = $new_servcies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
                    <div class="product-thumb">
                        <header class="product-header">
                            <img src="<?php echo e(asset('storage/'.$s->image)); ?>" alt="Image Alternative text" title="Gamer Chick" style="max-height :200px;" />
                        </header>
                        <div class="product-inner">
                            <ul class="icon-group icon-list-rating" title="4.7/5 rating">
                                <li><i class="fa fa-star"></i>
                       ...
                       <?php $__currentLoopData = $allcat->slice(0,6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-2 col-md-2">
                            <div class="single-service">
                                ...
                                <img src="<?php echo e(asset('storage/'. $c->image)); ?>"  style=" max-width: 100px; max-height: 76px;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/royal2.royalsooq.com/resources/views/home.blade.php ENDPATH**/ ?>