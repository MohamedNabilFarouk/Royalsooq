...
<form action="<?php echo e(route('free.ads.update',$ad->id)); ?>" method="post"  id="myform" enctype="multipart/form-data">
            ...
            <div class="ad-section-item">
                <div class="form-group">
                    ...
                    <div class="danger"><?php echo e(__('validation.required')); ?></div>
                        <?php endif; ?>
                        <select class="form-control" size="1" name='category_id'  id='sel_cat' readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="danger"><?php echo e(__('validation.required')); ?></div>
                        <?php endif; ?>
                        <select name='subcategory_id' id='sel_sub' class="form-control" size="1" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="danger"><?php echo e(__('validation.required')); ?></div>
                        <?php endif; ?>
                        <input type='text' name="name"  value="<?php echo e($ad->name); ?>" class="form-control" id='ip_name' placeholder="<?php echo e(__('index.product')); ?> <?php echo e(__('index.name')); ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-line">
                    ...
                    <div class="danger"><?php echo e(__('validation.required')); ?></div>
                        <?php endif; ?>
                        <textarea name="description" id="ip_description" class="form-control"><?php echo e($ad->description); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-inline flex-nowrap">
                    ...
                    <div class="danger"><?php echo e(__('validation.required')); ?></div>
                        <?php endif; ?>
                        <input type="number" name='price' value='<?php echo e($ad->price); ?>' class="form-control" id="ip_price" placeholder="<?php echo e(__('index.price')); ?>" required>
                ...
                <div class="form-group">
                    <div class="form-line">
                        ...
                        <input type="text" name="map" value="<?php echo e($ad->map); ?>" class="form-control"  placeholder="<?php echo e(__('index.map_frame')); ?>" >
                    </div>
                </div>
