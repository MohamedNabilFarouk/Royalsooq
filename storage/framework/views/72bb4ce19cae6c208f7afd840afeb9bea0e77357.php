...
<a-layout-header class="bg-white z-1 p-0">
    ...
    <a-menu class="header-nav" mode="horizontal">
        <a-sub-menu key="header-account">
            ...
            <a-menu-item key="2">
                <a href="<?php echo e(route('admin.product.show',$note->data['product_id'])); ?>">
...
<?php /**PATH E:\laravel_volcano_projects\Royal-details\royal_git\vendor\avored\framework\src/../resources/views/partials/header.blade.php ENDPATH**/ ?>