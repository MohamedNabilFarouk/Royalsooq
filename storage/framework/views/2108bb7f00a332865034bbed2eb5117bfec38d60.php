<div class="global-wrap">
        ...
        <header class="main" >
                            ...
                            <div class="row" style="border-top: solid 2px #efc718;align-items: center;justify-content: center;display: flex;">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <nav class="mob-nav">
                                        ...
                                        <li><a href="<?php echo e(url('login')); ?>" class="navBar-item"><?php echo e(__('index.log_in')); ?></a> </li>

                                            <li><a href="<?php echo e(url('register')); ?>" class="navBar-item"><?php echo e(__('index.sign_up')); ?></a> </li>



                                            <li><a href="<?php echo e(route('privacy')); ?>" class="navBar-item"><?php echo e(__('index.privacy')); ?></a> </li>
            ...
            <li><a href="<?php echo e(route('terms')); ?>" class="navBar-item"><?php echo e(__('index.term_of_use')); ?></a> </li>
                                            ...
                                            <li class="lang"><a href="<?php echo e(LaravelLocalization::getLocalizedURL('ar')); ?>" class="navBar-item" style="

                position: inherit; border-right: 0;"><img src="<?php echo e(asset('img/logos/Egypt-Flag-1-icon.png')); ?>" style="width: 17px;cursor: pointer;" data-toggle="modal" data-target="#myModal"> اللغة العربية</a> </li>

                         <?php else: ?>    

                         <li class="lang"><a href="<?php echo e(LaravelLocalization::getLocalizedURL('en')); ?>" class="navBar-item" style="

                position: inherit;border-right: 0;"><img src="<?php echo e(asset('img/logos/uk.png')); ?>" style="width: 17px;cursor: pointer;" data-toggle="modal" data-target="#myModal">  English</a> </li>    
...
<div class="col-lg-4 col-xs-4">
                      <a href="/" class="logo g" style=" display: inline;">
                                ...
                                <img src="<?php echo e(asset('img/logos/Royal Sooq.png')); ?>" alt="Royal Sooq رويال سوق" title="Royal Sooq رويال سوق" style="width:85px;;margin-top:11px;">

                                 <!-- <h6 class="royal" style=""><a href="/" style="color: black !important; font-weight: 600;"><?php echo e($page_title ?? 'RoyalSooq'); ?></a></h6> -->
         ...
         <div>
                        ...
                        <div id="myModal" class="modal fade" role="dialog">
                            ...
                            <div class="modal-content" style="z-index: 999999;">
                               ...
                               <h4 class="modal-title"><?php echo e(__('index.Regional Settings')); ?></h4>

                                </div>

                                <form action='<?php echo e(url("country")); ?>' method="get">

                                  <?php echo csrf_field(); ?>

                                <div class="modal-body">

                                <h4 class="modal-title"><?php echo e(__('index.choose country')); ?></h4>
                                    ...
                                    <?php $__currentLoopData = $allCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option value="1" data-thumbnail="https://cdn4.iconfinder.com/data/icons/africa-flags-1/1000/egypt-512.png"> <?php echo e($c->name); ?></option>

                                        <?php else: ?>

                                        <option value="2" data-thumbnail="https://cdn.countryflags.com/thumbs/saudi-arabia/flag-400.png" >  <?php echo e($c->name); ?></option>
...
<hr />
   ...
   <h4 class="modal-title"><?php echo e(__('index.Choose language')); ?></h4>

 <select class="selectpicker" onchange="location = this.value;">

 <?php $__currentLoopData = LaravelLocalization::getSupportedLocales(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localeCode => $properties): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

  <option value="<?php echo e(LaravelLocalization::getLocalizedURL($localeCode, null, [], true)); ?>" <?php if($properties["native"]== 'العربية'): ?> data-thumbnail="https://cdn.countryflags.com/thumbs/saudi-arabia/flag-400.png

" 

    <?php else: ?> data-thumbnail="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Flag_of_the_United_Kingdom.svg/640px-Flag_of_the_United_Kingdom.svg.png" <?php endif; ?> >  <?php echo e($properties['native']); ?></option>
...
"><i class="fa fa-floppy-o"></i> <?php echo e(__('index.save')); ?></button>
...
">
                ...
                <input type="text" class="form-control" name="name" placeholder="<?php echo e(__('index.search')); ?>" >

                <span class="input-group-btn  d-inline-block" tabindex="0" data-toggle="tooltip" title="<?php echo e(__('index.allAds')); ?>">
...
"><a href="<?php echo e(url('login')); ?>" data-effect="mfp-move-from-top"><?php echo e(__('index.log_in')); ?></a>

                            <a class="rig" href="<?php echo e(url('register')); ?>" data-effect="mfp-move-from-top"><?php echo e(__('index.sign_up')); ?></a>
                            ...
                            <li class="shopping-cart"><a href="<?php echo e(route('charts')); ?>" style="color:black !important ; text-transform: capitalize;  "><i class="fa fa-shopping-user color-fa"></i><span style="font-size:15px;"><?php echo e(__('index.welcome')); ?> <?php echo e(Auth::user()->name); ?></span> </a>

                            <?php else: ?>

                            <li class="shopping-cart"><a href="<?php echo e(url('/account')); ?>" style="color:black !important ; text-transform: capitalize;  "><i class="fa fa-shopping-user color-fa"></i><span style="font-size:15px;"><?php echo e(__('index.welcome')); ?> <?php echo e(Auth::user()->name); ?> </span></a>
                        ...
                        <div class="shopping-cart-box" style="z-index:2000 !important;">
                            ...
                            <ul role="menu" class="ant-menu ant-menu-inline ant-menu-root ant-menu-light">
                                ...
                                <li role="menuitem" class="ant-menu-item" style="padding-left: 24px;"><a href="<?php echo e(route('user.freeAds')); ?>"><span class="fa fa-star"></span>  <?php echo e(__("index.my_ads")); ?>&nbsp;<span class="badge badge-pill"><?php echo e(count(Auth::user()->products)); ?></span></a></li>

                                <li role="menuitem" class="my ant-menu-item" style="padding-left: 24px;"><a href="<?php echo e(route('favorites')); ?>"><span class="fa fa-heart"></span>   <?php echo e(__("index.favorite_ads")); ?>&nbsp; <span class="badge badge-pill"><?php echo e(count(Auth::user()->wish)); ?></span></a></li><li role="menuitem" class="ant-menu-item" style="padding-left: 24px;"><a href="<?php echo e(route('search.saved')); ?>"><span class="fa fa-floppy-o"></span>   <?php echo e(__("index.saved_search")); ?> </a></li>
          
                                <li role="menuitem" class="ant-menu-item" style="padding-left: 24px;"><a href="<?php echo e(route('shops.data')); ?>"><span class="fa fa-shopping-bag"></span>   <?php echo e(__('index.shop_info')); ?>&nbsp;</a></li>

                                <li role="menuitem" class="ant-menu-item" style="padding-left: 24px;"><a href="<?php echo e(route('shops2', auth()->user()->id)); ?>"><span class="fa fa-shopping-bag"></span>   <?php echo e(__('index.your_shops')); ?>&nbsp;</a></li>
...
<!-- orders -->
    ...
    <div style="background-color: #fff; border-bottom: 3px solid #0d4f6d; margin-top: 5px;">
                                    ...
                                    <div class="col-md-10 cat2">
                                        ...
                                        <?php $__currentLoopData = $allcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="category" id='<?php echo e($c->id); ?>'>
                                                ...
                                                <h6 style="font-weight: 500; text-align: center;"> <a href="<?php echo e(route('cat.products', $c->slug)); ?>"> <?php echo e($c->name); ?> </a>  </h6>
                            ...
                            <?php $__currentLoopData = $allcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $c->subcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <h4 style="color: white;"><a href="<?php echo e(route('sub.products',$sub->slug)); ?>"> <?php echo e($sub->name); ?><a></h4>
     ...
     $(this).parent().next('ul').slideToggle();
      ...
      <?php echo $__env->yieldPushContent('scripts'); ?><?php /**PATH E:\Billy\laravel_volcano_projects\Royal-details\new_royal\resources\views/layouts/inc-top.blade.php ENDPATH**/ ?>