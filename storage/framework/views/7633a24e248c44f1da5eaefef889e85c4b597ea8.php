...
<nav class="navbar navbar-expand-lg bg-header">
    <div class="container-fluid justify-content-start">
        ...
        <div class="navbar-heading m-l-10">
            <h4><?php echo e(__('index.favorite_ads')); ?></h4>
        </div>
    </div>
</nav>
<!-- .Header  -->
...
<div id="content" style="margin-top:80px;">
    ...
    <div class="content-wrap">
        <?php $__currentLoopData = $wishlists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="ad-section-item">
                <div class="ad-box list">
                    ...
                    <div class="ad-content">
                        <a href="<?php echo e(route('product.details', $p)); ?>" class="ad-title"><?php echo e($p->name); ?></a>
                        ...
                        <div class="d-flex flex-wrap align-items-center m-t-5">
                            ...
                            <div class="ml-auto">
                                <form action="<?php echo e(route('delete.favorites',$p->id)); ?>" method="POST" id='delForm'>
