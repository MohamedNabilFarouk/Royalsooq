...
<ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo e(__("index.shop_info")); ?></li>
...
border: #e2e2e2 1px solid;">
                ...
                <section id="login">
                            ...
                            <div class="col-xs-12">
                                <div class="form-wrap">
                                <h1><?php echo e(__('index.shop_info')); ?></h1>
                                    ...
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group">
                                            <label for="key" class="sr-only"><?php echo e(__('index.shop_about')); ?></label>
...
<!-- end images -->
                        ...
                        <input type="submit" id="btn-login" class="btn btn-custom btn-lg btn-block" value="<?php echo e(__('index.save')); ?>">
                    </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/resources/views/blades/shop_data.blade.php ENDPATH**/ ?>