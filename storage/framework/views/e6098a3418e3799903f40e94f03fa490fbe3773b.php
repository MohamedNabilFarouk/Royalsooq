            ...
            <div class="container-fluid">
                <div class="row flex-wrap">
                    <div class="col-md-2 col-12 text-center" style="display: flex;  justify-content: space-between; align-items: center;">
                        <div>
                            <a href="/" class="logo">
                                <img src="<?php echo e(asset('img/logos/Royal Sooq.png')); ?>" alt="Image Alternative text" title="Image Title" style="width:150px;margin-top:5px;" />
                            </a>
                        </div>  
                    ...
                    <div class="col-md-6">                       
                       <img src="https://via.placeholder.com/150/FF0000/FFFFFF?Text=Down.com" style="width: 100%;height: 73px; margin-top: 7px;">
                        </div>
                    <div class="col-md-4 col-12 text-center" style="padding: 15px 6px;display: flex;justify-content: flex-end;align-items: center;">
                        ...
                        <div class="pull-right">
                            <ul class="header-features">
                                <li>
                                    <div class="header-feature-caption chande">
                                      ...
                                      <?php if((Auth::user()->seller)=='1'): ?>
                                        <button class="btn btn-primary secondNavButtons"><a class=""  href="<?php echo e(route('service.page')); ?>"> Services </a></button>
                                    <?php endif; ?>
                                        <?php endif; ?>
                                ...
                                <li>
                                    <div class="header-feature-caption chande">
                                        <button class="btn btn-primary secondNavButtons"><a class=""  href="<?php echo e(route('shops')); ?>" style="color: white;text-decoration: none;"> Shops</a></button>
                                    </div>
                                </li>
                                <li>
                                    <div class="header-feature-caption chande">
                             ...
                             <div class="col-md-12" style="display: flex;"> 
                              ...
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                               ...
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group" style="display: flex;     margin-bottom: 0; width: 540px;">
  ...
  <label for="other">sponsore product.</label>
                    ...
                    <div class="col-md-2" style='padding:0px;'>
                        ...
                        <ul class="login-register">
                            <li class="shopping-cart"><a href="<?php echo e(route('cart.show')); ?>" style="color:black !important"><img src="<?php echo e(asset('img/logos/Shopping Cart .png')); ?>" style="width:50px;"> </a>
                            ...
                            <li style="
    display: inline-flex;
"><a class="popup-text" href="#login-dialog" data-effect="mfp-move-from-top" style="color: white!important;background: #efc718;border-radius: 0;/* display: inline-block; */ border-bottom-left-radius: 7px;
    ...
    border-top-right-radius: 7px;">Sign up</a>
                            ...
                            <?php if(auth()->guard()->check()): ?>    
                            <?php if((Auth::user()->seller)=='1'): ?>
                            <li class="shopping-cart"><a href="<?php echo e(route('charts')); ?>" style="color:black !important ;  "><i class="fa fa-shopping-user color-fa"></i>Hello <?php echo e(Auth::user()->name); ?> </a>
                            <?php else: ?>
        ...
        <header class="main categoryBar" style="background-color: #2a8fbd;padding-top:10px;position: relative;border:2px solid #2a8fbd;border-top: solid 5px #efc718;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-1">
                        <h6 style="font-weight: 600;color:white"><a href="<?php echo e(route('allCategories')); ?>"> All Categories</a> </h6>
                    </div>
                    <div class="col-md-11">
...
<?php /**PATH E:\Billy\laravel_volcano_projects\Royal-details\royal_git\resources\views/layouts/app.blade.php ENDPATH**/ ?>