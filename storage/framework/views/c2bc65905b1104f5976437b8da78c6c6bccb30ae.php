                            ...
                            <div class="product-view pull-right">
                                ...
                                <div class="product-thumb product-thumb-horizontal">
                                    ...
                                    <div class="product-inner">
                                        ...
                                        <div class="product-desciption"><span class="item-location"><i class="fa fa-map-marker"></i> <?php if($p->city): ?><?php echo e($p->city->city); ?> <?php endif; ?> </span> | <span>city</span> | <span><?php echo e(date_format($p->created_at,'d M Y')); ?></span>
                                        <br>
                                        ...
                                        <ul class="product-actions-list style2">
                                                <li><a class="btn btn-sm" href="#"><i class="fa fa-heart-o" aria-hidden="true"></i> Add to favorites</a>
                                                </li>
                                                <li><a class="btn btn-sm"><i class="fa fa-phone" style="color: #428bca;" aria-hidden="true"></i> Call</a>
                                                </li>
                                                     <li><a class="btn btn-sm"><i class="fa fa-comments" style="color: #428bca;" aria-hidden="true"></i> Chat</a>
                                                </li>
                                            </ul>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_volcano_projects\Royal-details\royal_git\resources\views/blades/shops2.blade.php ENDPATH**/ ?>