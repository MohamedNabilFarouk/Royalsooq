 <a-form-item
    ...
    <?php endif; ?>
    label="<?php echo e(__('avored::system.configuration.user.user_name')); ?>">
    <a-input
        :auto-focus="true"
        name="site_name"
        v-decorator="[
...
<?php /**PATH E:\Billy\laravel_volcano_projects\Royal-details\royal_git\vendor\avored\framework\src/../resources/views/system/configuration/cards/user.blade.php ENDPATH**/ ?>