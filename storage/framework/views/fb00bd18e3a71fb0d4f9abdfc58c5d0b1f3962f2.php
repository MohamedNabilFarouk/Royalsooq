...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>  
    ...
    body{
        font-family: sans-serif; !importanat;
    }
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <img src="<?php echo e(asset('img/logos/FAVPNG_flag-of-saudi-arabia-flag-of-the-united-states-flag-of-afghanistan_E9PM0TeK.png')); ?>" width="50px" height="50px">
                ...
                <div class="row  align-items-center justify-content-center align-content-center" style='padding:5px;'>
                    ...
                    <div class="col-md-3" style='padding:0px;'>
                        ...
                        <ul class="login-register">
                            ...
                            <li><a class="popup-text" href="#login-dialog" data-effect="mfp-move-from-top" style="color: white!important;background: darkgrey;border-radius: 10px;">Sign in</a>
                            ...
                            <li><a class="popup-text" href="#register-dialog" data-effect="mfp-move-from-top" style="color: white!important;background: gray;border-radius: 10px;">Sign up</a>
...
<?php /**PATH E:\Billy\laravel_volcano_projects\Royal-details\royal_git\resources\views/layouts/user.blade.php ENDPATH**/ ?>