...
<div class="container">
    <ul class="breadcrumb">
                    ...
                    <li><a href="#"><?php echo e(__('index.freeAds')); ?></a>
                    </li>
                </ul>
            <div class="row">
		...
		<div class="inner-box">
			...
			<div class="row">
								...
								<div class="row">
                                                                            ...
                                                                            <?php $__currentLoopData = $egy_cities->slice(0,15); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                
                                                                            <li>
																				        <a href="<?php echo e(route('productsByCity', $c->id)); ?>">
                                                                                            <?php echo e($c->city); ?>
																			...
																			<ul class="cat-list col-md-4 col-sm-6 col-xs-12 ">
                                                                            <?php $__currentLoopData = $egy_cities->slice(15,27); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                
                                                                            <li>
																				        <a href="<?php echo e(route('productsByCity', $c->id)); ?>">
                                                                                            <?php echo e($c->city); ?> 
                                                                                        </a>
                                                                            ...
                                                                            <?php $__currentLoopData = $egy_cities->slice(12,22); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                
                                                                            <li>
																				        <a href="#">
                                                                                            <?php echo e($c->city); ?>
...
<svg baseProfile="tiny" fill="#7c7c7c" height="300" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" version="1.2" viewBox="0 0 1000 889" width="300" xmlns="http://www.w3.org/2000/svg" style="background: transparent;">
 ...
 <circle cx="550.8" cy="96.3" id="2">
            ...
            <div class="animated" id='firstHomeSection'>
                ...
                <div class="">
                    <h1 class="mb20 text-center"> <?php echo e(__('index.feature')); ?> <small><a href="#"></a></small></h1>
                    <div class="row row-wrap home-owlC2" style="width:100%;">
                       
                    <?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                    <div>
...
<br>
   ...
   <div class="">
                    <h1 class="mb20 text-center"> <?php echo e(__('index.latest')); ?> <small><a href="#"></a></small></h1>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/o12s5ul8n01l/public_html/royal2.royalsooq.com/resources/views/blades/allFreeAds.blade.php ENDPATH**/ ?>