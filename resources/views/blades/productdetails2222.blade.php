...
@section('content')
<?php
$products[0]->visits()->increment();

// echo $products[0]->visits()->count();
?>
<style>
iframe{
    width:100%; !important;
...
">
                            ...
                            <span class="date"><i class="fa fa-clock-o"> </i>{{date_format($products[0]->created_at,'d M Y')}}</li></span> -&nbsp;
							<span class="category">
								<i class="fa fa-eye"></i>
...
@if(count($products[0]->images) == 1)
  ...
  @else
                        ...
                        <?php $c=0;?>
        <div class="fotorama" data-nav="thumbs" data-allowfullscreen="1">
...
">&nbsp;
        ...
        <img src="{{asset('/storage/'. $products[0]->user->image)}}" alt="{{$products[0]->user->name}}" style="width: 24%;
    float: right;
    border-radius: 16%;
" >
        @endif
...
<h5 class="title">{{__('index.posted_by')}}    </h5>
...
<style>
  ...
  color: orange;
                                ...
                                <ul class="list-inline">
                                    <li style="margin-top: 18px;background: #87b821;border-radius: 3px;">
                                        <div class="phoneNumber table getPhoneNumber" data-ghost="Ad-OwnerPhone" onclick="getPhoneNumber($(this),'OwnerCallBtn_PostViewScreen')" data-action="user-card" data-id="127703448" data-type="post" data-chat-msg=""><span class="tableCell center icon-phone3"></span><span dir="ltr" class="tableCell center sellerPhone "><span class="popupPhone">
                    0111675555                    </span><strong class="block">
                                   </strong></span></div>
                        <span class="fa fa-phone"></span>
                        <style>
                    .phoneNumber.table.getPhoneNumber {
    margin: 15px auto 0;
...
span.fa.fa-phone {
    ...
    padding: 10px;
                                        ...
                                        <!--<a href="#tab-2" data-toggle="tab"  class="btn btn-primary con"><i class="fa fa-phone"></i>{{__('index.contact_with_seller')}}</a>-->
                                    </li>
                                    <li style="margin-top: 20px;"><a href="{{route('chat.message',$products[0]->id)}}"   class="btn btn-primary cha"><i class="fa fa-comment"></i>{{__('index.chat')}}</a>
