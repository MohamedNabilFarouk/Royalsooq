      ...
      <div class="col-md-9">
         ...
         <a class="product-thumb product-thumb-horizontal" href="{{route('product.details',$p->slug ?? $p)}}">
            ...
            <div class="product-inner" style="
               ...
               <button  class="btn btn-primary hov3 chat" style="padding-right: 52px;padding-left: 40px;margin: 11px;border: 1px solid red;border-color: #efc718 !important;color: red;"  ><i class="fa fa-comments" style="c" aria-hidden='true' ></i> {{__('index.chat')}} {{__('index.soon')}}</button>               </div>
            </div>
         </a>
         @endforeach
         @else 
