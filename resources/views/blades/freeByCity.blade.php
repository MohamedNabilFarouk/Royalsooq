...
<ul class="breadcrumb">
                    ...
                    <li><a href="{{route('free.ads.all')}}">Free Ads</a>

                    </li>

                    <li><a href="#">{{$products[0]->city->city ?? ''}}</a>
...
<ul  class="ant-menu ant-menu-inline ant-menu-root ant-menu-light" style="display: block;">
            ...
            <div class="sidebar-box"id="multiCollapseExample1">  
                    ...
                    <ul class="checkbox-list">
                                ...
                                <form action="{{route('productsByCity', $products[0]->city->id ?? '' )}}" method="GET"> 
...
@if(($product->approved == 1))
                        ...
                        <ul class="icon-group icon-list-rating" title="{{ number_format($product->averageRating)}}/5 rating">
                            ...
                            <div class="product-meta">
                                ...
                                <li><a href="{{route('product.details' ,$product->slug)}}" class="btn btn-sm chat"  style="
