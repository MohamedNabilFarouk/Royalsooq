...
<label >
    ...
    @if(($ad->categories->id) == $c->id)

<input class='form-group' type="radio" name="category_id" value="{{$c->id}}" id="sel_cat" checked>
@else
<input class='form-group' type="radio" name="category_id" value="{{$c->id}}" id="sel_cat" >
@endif
...
<div class="row row-wrap" id='sub' >
    <li> <label> <input class="form-group" type="radio" name="subcategory_id" id="sel_sub2" value="{{$ad->subcategory_id}}" checked><h4 id="sub_name_{{$ad->subcategory_id}}" style="color: #025D8C;">{{$ad->subcategory->name ?? ''}}</h4> </label> </li>
...
">{{__('index.save')}}</button>
    ...
    <div class="col-md-5 col-12 text-center ">
      <h3 id='category'>{{$ad->categories->name}}</h3> <h3 id='subcategory'>{{$ad->subcategory->name ?? ''}}</h3>
      <div id='catimg'></div>
...
console.log("It failed");
                        ...
                        <div class="row row-wrap" style="display: flex;justify-content: center;">
                                            ...
                                            <div class="col-md-8 col-12 text-center ">
                                                  ...
                                                  <input type="text" name="video" class="form-control"  placeholder="{{__('index.vid_link')}}" >
...
<input type="text" name="map" class="form-control" value="{{$ad->map}}"  placeholder="{{__('index.map_view')}}" >
                        ...
                        <div class="row row-wrap" style="display: flex;justify-content: center;">
                                                    ...
                                                    <div class="col-md-4  col-12 text-center " style="border-top: gray 1px solid; padding-top: 10px;width: 100%;">
                                                        ...
                                                        <input type="submit" name="submit" value="{{__('index.edit')}}" style="background-color: #025D8C;border: 0px;padding: 5px 10px;color: white;border-radius: 5px;">
