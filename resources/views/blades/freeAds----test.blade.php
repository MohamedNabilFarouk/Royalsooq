        ...
        <div class="">
                        ...
                        <div class="row row-wrap" style="display: flex;justify-content: center;">
                                            ...
                                            <div class="col-md-8 col-12 text-center ">
                                                  ...
                                                  <input type="text" name="name" value='{{ old('name') }}'  class="form-control" id='ip_name' placeholder="{{__('index.product')}} {{__('index.name')}}" required>
                        ...
                        <div class="row row-wrap" style="display: flex;justify-content: center;">
                                                      ...
                                                      <div class="col-md-2  col-12 text-center ">
                                                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#mycat">{{__('index.category')}}</button>
  ...
  <div class="modal fade" id="mysubcat" role="dialog">
    <div class="modal-dialog koz">
      ...
      <div class="modal-content koz">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" id='closeModal' data-dismiss="modal">OK</button>
        </div>
      </div>
...
var  ip_description = $('#ip_description').val();

var ip_price = $('#ip_price').val();
