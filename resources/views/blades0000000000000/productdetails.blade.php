...
">
							...
							<small class="label label-default adlistingtype">Professional</small>
								                            	 				...
								                            	 				<span class="info-row">
							<span class="date"><i class="fa fa-map-marker"> </i> 3 {{$products[0]->city->city ?? ''}} </span> -&nbsp;
						
						
							<span class="category">
								<i class="fa fa-eye"></i>
{{$products[0]->visits()->count()}} views
							</span>&nbsp;
...
@if(count($products[0]->images) == 1)
  ...
  @else
                        ...
                        <?php $c=0;?>
        <div class="fotorama" data-nav="thumbs" data-allowfullscreen="1" data-thumbheight="70" data-thumbwidth="150" >
...
<style>
  ...
  color: orange;
                                ...
                                <ul class="list-inline">
                                    <li style="margin-top: 20px;"><a href="#tab-2" data-toggle="tab"  class="btn btn-primary"><i class="fa fa-phone"></i>{{__('index.contact_with_seller')}}</a>
                                    </li>
                                    <li style="margin-top: 20px;"><a href="{{route('chat.message',$products[0]->id)}}"   class="btn btn-primary"><i class="fa fa-comment"></i>{{__('index.chat')}}</a>
...
">
    ...
    margin-top: 20px;
text-align: center;">
                         <h3 style="text-align:center;font-size: larger;background: white;padding: 14px;">Safety Tips for Buyers</h3>
                    <ul class="icon-list list-space product-info-list">
                                    <li><i class="fa fa-check"></i>Meet seller at a public place</li>
                                    <li><i class="fa fa-check"></i>Check the item before you buy</li>
                                    <li><i class="fa fa-check"></i>Pay only after get the item</li>
                    ...
                    <div class="product-thumb">
                        ...
                        <?php echo str_repeat('<span class="fa fa-star"></span>', 5 - number_format($product->averageRating)) ?> 
                            ...
                            <div class="product-meta">
                                ...
                                @endauth -->
                                <li><a href="{{route('chat.message',$product->id)}}" class="btn btn-sm"  style="
