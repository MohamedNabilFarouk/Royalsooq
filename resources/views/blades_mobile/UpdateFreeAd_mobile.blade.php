...
<form action="{{route('free.ads.update',$ad->id)}}" method="post"  id="myform" enctype="multipart/form-data">
    {{ method_field('PUT') }}
        ...
        <div class="ad-section">
            <div class="ad-section-item">
                ...
                <div class="form-group">
                    ...
                    <div class="danger">{{__('validation.required')}}</div>
                        @endif
                        <input type='text' name="name"  value="{{$ad->name}}" class="form-control" id='ip_name' placeholder="{{__('index.product')}} {{__('index.name')}}" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-line">
                    ...
                    <div class="danger">{{__('validation.required')}}</div>
                        @endif
                        <textarea name="description" id="ip_description" class="form-control">{{$ad->description}}</textarea>
                    </div>
                </div>
                ...
                <div class="form-inline flex-nowrap">
                    ...
                    <div class="danger">{{__('validation.required')}}</div>
                        @endif
                        <input type="number" name='price' value='{{$ad->price}}' class="form-control" id="ip_price" placeholder="{{__('index.price')}}" required>
                ...
                <div class="form-group">
                    <div class="form-line">
                        ...
                        <input type="text" name="map" value="{{$ad->map}}" class="form-control"  placeholder="{{__('index.map_frame')}}" >
                    </div>
                </div>
