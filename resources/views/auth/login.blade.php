...
">
    ...
    <input type="password" name="password" placeholder="{{__('index.password')}}"style="
...
<!--                            <input type="password" name="password" id="key" class="form-control" placeholder="{{__('index.password')}}">-->
...
<!--                        <input type="submit" id="btn-login" class="btn btn-custom btn-lg btn-block" value="{{__('index.log_in')}}">-->
