            ...
            <div class="container">
              ...
              @if ($errors->any())
                ...
                @if (session('status'))
                    ...
                    @endif
              <form role="form" action="{{ route('password.update') }}" method="post" id="login-form" autocomplete="off">
                @csrf
                ...
                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('index.pass_confirmition') }}</label>
              ...
              <button>{{ __('index.Reset_Password') }}</button>
    </form>
