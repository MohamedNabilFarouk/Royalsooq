            ...
            <a-row :gutter="20" class="mt-1">
                    ...
                    <a-card title="Apply Promotion Code">
                        ...
                        <div>
                            <form method="get" :form="form" @submit="handleCouponSubmit" action="">
                                ...
                                <a-form-item>
                                    <a-button html-type="submit" type="primary" style="background-color:#2A8FBD;">{{ __('Apply') }}</a-button>
                                </a-form-item>
                            </form>
                        </div>
                        @else
                ...
                <a-col :span="8" :push="4">
                    ...
                    <a class="btn-checkout" href="{{ route('checkout.show') }}">
                        <a-button type="primary" style="background-color:#2A8FBD;">{{ __('Checkout') }}</a-button>
                    </a>
