...
<body>
    ...
    color: white;
">
                    	<span id="search_concept"> <img src="https://s3.amazonaws.com/codecademy-content/projects/2/birdman/menu.svg" width="30px"></span> <span class="caret"></span>
                    </button>
...
"><a class="popup-text" href="#login-dialog" data-effect="mfp-move-from-top" style="color: white!important;background: #efc718;border-radius: 0;/* display: inline-block; */ border-bottom-left-radius: 7px;
                        ...
                        <div class="shopping-cart-box" style="z-index:2000 !important;">
                            ...
                            @endauth
                                ...
                                <li>
                                    ...
                                    @auth    
                                    <button class="btn btn-primary secondNavButtons" ><a class=""  href="{{route('free.ads')}}" style="color: white;text-decoration: none;"> <i class="fa fa-camera" aria-hidden="true" style="color: black;text-decoration: none;"></i> Post Ad Now</a> </button>
                                @endauth
                                @guest 
    ...
    <div style="background-color: #fff;">
        ...
        <header class="main categoryBar" style="background-color: #2a8fbd;position: relative;border:2px solid #2a8fbd;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-1" style="font-weight: 600;color:white;font-size: 13px;padding-top: 11px;background: #efc718;">
