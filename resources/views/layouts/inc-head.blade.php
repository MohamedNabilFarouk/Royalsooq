   ...
   <title>@if(isset($page_title)){{$page_title . '| Royal Sooq رويال سوق '}} @else {{'Royal Sooq رويال سوق'}}@endif</title>
...
<link rel="icon"  href="{{asset('img/logos/vv.png')}}" type="image/gif" sizes="16x16">
...
<!-- user.blade --> <script src="{{ asset('js/app.js') }}" defer></script>
...
<link rel="stylesheet" href="{{asset('css/Arabic/mystyles.css')}}">
