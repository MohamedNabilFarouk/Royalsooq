                ...
                <div class="col-md-4 col-12 text-center" style="display: flex;  justify-content: space-between; align-items: center;">
                    <div>
                        <a href="index-2.html" class="logo">
                            <img src="{{asset('img/logos/logo (1).png')}}" alt="Image Alternative text" title="Image Title" style="width:100px" />
                        </a>
                    </div>
                    <div>
    ...
    <div class="col-md-1 pt-3">
                      ...
                      <!-- login and register and cart -->
                        ...
                        <ul class="login-register">
                            <li class="shopping-cart"><a href="{{route('cart.show')}}"><i class="fa fa-shopping-cart"></i>My Cart</a>
                            ...
                            <li class="dropdown-submenu">
                                           <a tabindex="-1" href="{{url('/account')}}" class="dropdown-submenu-toggle">Hello {{Auth::user()->name}} <b class="caret"></b></a>
...
<!--end filter -->
        <header class="main">
           ...
           @foreach($allcat as $c)
                                <li class=""><a href="index.html">{{$c->name}}</a> </li>
@endforeach
